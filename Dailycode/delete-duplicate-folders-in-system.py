...
class Solution:
    def deleteDuplicateFolder(self, paths):
        ...
        # Build result by skipping duplicate signatures
        result = []
        current_path = []
...
print("Example 1 Output:", sol.deleteDuplicateFolder(paths1))

# Example 2
paths2 = [["a"],["c"],["a","b"],["c","b"],["a","b","x"],["a","b","x","y"],["w"],["w","y"]]
print("Example 2 Output:", sol.deleteDuplicateFolder(paths2))

# Example 3
paths3 = [["a","b"],["c","d"],["c"],["a"]]
print("Example 3 Output:", sol.deleteDuplicateFolder(paths3))
